...
// ExtendedContract type that extends the ethers.Contract type
// This allows for dynamic property access for TypeScript compatibility
export interface ExtendedContract extends ethers.Contract {
  ...
  // Paymaster Module Methods
  depositEth?: (userAddressOrOverrides?: string | { value: ethers.BigNumberish }, overrides?: any) => Promise<ethers.ContractTransaction>;
  ...
  // Token Management Module Methods
  ...
  tokenApprovals?: (tokenAddress: string, spender: string) => Promise<{ allowance: ethers.BigNumber, isApprovedForAll: boolean }>;
  getTokenAllowance?: (tokenAddress: string, spender: string) => Promise<{ allowance: ethers.BigNumber, isApprovedForAll: boolean }>;
  getTokenBalance?: (tokenAddress: string, tokenId?: ethers.BigNumberish) => Promise<{ balance: ethers.BigNumber, tokenType: number }>;
...
export function createExtendedContract(address: string, abi: any, provider: any): ExtendedContract {
  return new ethers.Contract(address, abi, provider) as ExtendedContract;
}
